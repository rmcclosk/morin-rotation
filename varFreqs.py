...
if __name__ == "__main__":
    ...
    for pos in positions:
        ...
        try:
            ...
            continue
        (ref, nonref, other_base) = countBasesAtPileupPosition(pileup, pos, ref_base)
        if nonref == 0:
            continue
        #VAF is ref / (nonref + ref)
        #print "%s %s,%s %s>%s" % (pos,ref,nonref,ref_base,other_base)
        print("{} {},{} {}>{}".format(pos, ref, nonref, ref_base, other_base))
